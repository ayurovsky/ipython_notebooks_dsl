#TODO: to reproduce paper organisms results, only keep ATG in keep_only_valid_orfsS
...
# expected file
csv_with_tompa_sd_added = 'DiwanDataFiles_WithTompa_v2.csv'
csv_with_table_stats_added = 'DiwanDataFiles_WithAllStats_only_tompa_v4_121-180.csv'
